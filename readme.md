-------------------------------------------------------------------------
destructor.de Source Code Licence (DSL)
-------------------------------------------------------------------------
...
The goal of the makers of destructor.de is to provide free source code
and tools to the Borland Delphi community.

This licence ("DSL") covers all Source Codes provided on the 
www.destructor.de Internet Web site written by one of the destructor.de 
authors.
...
If you have questions about this license, please e-mail us at 
virtual@destructor.de or abstract@destructor.de
